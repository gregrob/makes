...
Personal collection of 3D designs, CAD files, and fabrication projects.
...
| Project | Description |
|---|---|
| `ms01-1u-psu-mount-1ru` | 1U rack mount PSU holder for Minisforum MS-01 - can mount up to 4 PSU's in a ms-01 cluster |
...
- CAD: Fusion 360
- Slicer: Bambu Studio
- Printer: Bambu P2S with AMS 2 Pro
